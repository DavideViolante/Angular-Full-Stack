import { Component, inject, WritableSignal, input, InputSignal } from '@angular/core';
...
export class AddCatFormComponent {
  ...
  cats: InputSignal<WritableSignal<Cat[]> | undefined> = input<WritableSignal<Cat[]> | undefined>();
