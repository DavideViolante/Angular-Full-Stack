...
import { CatsDataService } from '../services/cats.data.service';
import { ToastComponent } from '../../shared/components/toast/toast.component';

@Component({
  selector: 'app-home',
  templateUrl: '../templates/cats.component.html',
  styleUrls: ['../styles/cats.component.scss']
})
export class CatsComponent implements OnInit {
  ...
  constructor(private http: Http,
              private dataService: CatsDataService,
